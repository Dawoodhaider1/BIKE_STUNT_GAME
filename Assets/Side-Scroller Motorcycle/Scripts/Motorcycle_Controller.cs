...
public class Motorcycle_Controller : MonoBehaviour
{
    ...
    public Image throttleTexture;
    public Image brakeTexture;
    ...
    void Start()
    {
        ...
        //throttleTexture = mobileButtons.Find("throttle").GetComponent<Image>();
        //brakeTexture = mobileButtons.Find("brake").GetComponent<Image>();
        //leftTexture = mobileButtons.Find("left").GetComponent<Image>();
        //rightTexture = mobileButtons.Find("right").GetComponent<Image>();
        ...
        if (isControllable)
        {
            if (forMobile)
            {
                ...
                foreach (var touch in touches)
                {
                    ...
                    {
                        if (TouchPosition == throttleTexture.transform.position) //if touch position is inside throttle texture
                            accelerate = true;

                        if (TouchPosition == brakeTexture.transform.position) //if touch position is inside brake texture
                            brake = true;

                        if (TouchPosition == leftTexture.transform.position) //left button is touched
                            left = true;

                        if (TouchPosition == rightTexture.transform.position) //right button is touched
                            right = true;
